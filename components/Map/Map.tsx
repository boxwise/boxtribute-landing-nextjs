  ...
  return (
    ...
    >
      ...
      {baseMarkers.map((marker, i) => (
        <Marker key={i} icon={getMarkerIcon(marker.status)} position={[marker.position.lat, marker.position.long]}>
          <Popup
